...
var _BigListItemRecycler = _interopRequireDefault(
  require("./BigListItemRecycler")
);
...
class BigListProcessor {
  ...
  getItemHeight(section, index) {
    ...
    return (0, _utils.isNumeric)(itemHeight)
      ? Number(itemHeight)
  ...
  getHeaderHeight() {
    ...
    return (0, _utils.isNumeric)(headerHeight)
      ? Number(headerHeight)
      : headerHeight();
  }
  /**
  ...
  getFooterHeight() {
    ...
    return (0, _utils.isNumeric)(footerHeight)
      ? Number(footerHeight)
      : footerHeight();
  }
  /**
  ...
  getSectionHeaderHeight(section) {
    ...
    return (0, _utils.isNumeric)(sectionHeaderHeight)
  ...
  getSectionFooterHeight(section) {
    ...
    return (0, _utils.isNumeric)(sectionFooterHeight)
    ...
    for (let section = 0; section < sections.length; section++) {
      ...
      if (
        ...
        items[items.length - 1].type ===
          _BigListItem.BigListItemType.SECTION_HEADER
      ) {
        // Top Spacer
  ...
  scrollToPosition(targetSection, targetIndex, animated) {
    const { sections, insetTop } = this; // Header + inset
    ...
    while (section <= targetSection) {
      ...
      scrollTop += this.getSectionHeaderHeight(section); // Items
